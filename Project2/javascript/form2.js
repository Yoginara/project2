window.addEventListener('DOMContentLoaded', function () {
  // Ambil nilai inputBooking dari localStorage saat halaman dimuat
  if (localStorage.getItem('bookingCode')) {
    const inputBooking = localStorage.getItem('bookingCode');
    document.getElementById('displayBookingCode').innerText = inputBooking;
  }
});
